...
namespace HR.LeaveManagement.Persistance.Migrations
{
    ...
    [Migration("20230417104809_final")]
    partial class final
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HR.LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 4, 17, 16, 18, 9, 875, DateTimeKind.Local).AddTicks(9962),
                            DateModified = new DateTime(2023, 4, 17, 16, 18, 9, 875, DateTimeKind.Local).AddTicks(9977),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
